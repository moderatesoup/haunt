...
def memory_recall(
    ...
    bounded_hits, recall_budget = apply_recall_budget(hit_dicts, k=k)
    ...
    # `hits`, not `bounded_hits`: execution is stage evidence carried on the
    # planner's result object, not per-hit data. A plain list carries none.
