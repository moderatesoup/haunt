...
from haunt.model_manifest import (  # noqa: F401  (re-exported for E6 evidence)
...
# The E6 fixture/report schema. Distinct from
# model_manifest.MANIFEST_SCHEMA_VERSION, which versions the model artifact
# manifest document; the two are equal today and free to diverge.
SCHEMA_VERSION = 1
